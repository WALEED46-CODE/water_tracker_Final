...
The goal of this application is to provide a simple, intuitive desktop interface for users to monitor their hydration health directly from their active computer workstations. It helps prevent workplace dehydration by eliminating the need for secondary mobile tracking devices, so students and office workers can quickly maintain consistent daily intake-tracking habits.
